...
for filename, landmarks in all_landmarks.items():
    to_csv.append([filename, *landmarks])
# Convert the list of tuples into a DataFrame
df = pd.DataFrame(to_csv,
                  columns=['Filename', 'silhouette_10_x', 'silhouette_10_y', 'silhouette_338_x', 'silhouette_338_y',
                           'silhouette_297_x', 'silhouette_297_y', 'silhouette_332_x', 'silhouette_332_y',
                           'silhouette_284_x', 'silhouette_284_y', 'silhouette_251_x', 'silhouette_251_y',
                           'silhouette_389_x', 'silhouette_389_y', 'silhouette_356_x', 'silhouette_356_y',
                           'silhouette_454_x', 'silhouette_454_y', 'silhouette_323_x', 'silhouette_323_y',
                           'silhouette_361_x', 'silhouette_361_y', 'silhouette_288_x', 'silhouette_288_y',
                           'silhouette_397_x', 'silhouette_397_y', 'silhouette_365_x', 'silhouette_365_y',
                           'silhouette_379_x', 'silhouette_379_y', 'silhouette_378_x', 'silhouette_378_y',
                           'silhouette_400_x', 'silhouette_400_y', 'silhouette_377_x', 'silhouette_377_y',
                           'silhouette_152_x', 'silhouette_152_y', 'silhouette_148_x', 'silhouette_148_y',
                           'silhouette_176_x', 'silhouette_176_y', 'silhouette_149_x', 'silhouette_149_y',
                           'silhouette_150_x', 'silhouette_150_y', 'silhouette_136_x', 'silhouette_136_y',
                           'silhouette_172_x', 'silhouette_172_y', 'silhouette_58_x', 'silhouette_58_y',
                           'silhouette_132_x', 'silhouette_132_y', 'silhouette_93_x', 'silhouette_93_y',
                           'silhouette_234_x', 'silhouette_234_y', 'silhouette_127_x', 'silhouette_127_y',
                           'silhouette_162_x', 'silhouette_162_y', 'silhouette_21_x', 'silhouette_21_y',
                           'silhouette_54_x', 'silhouette_54_y', 'silhouette_103_x', 'silhouette_103_y',
                           'silhouette_67_x', 'silhouette_67_y', 'silhouette_109_x', 'silhouette_109_y',
                           'lipsUpperOuter_61_x', 'lipsUpperOuter_61_y', 'lipsUpperOuter_185_x', 'lipsUpperOuter_185_y',
                           ...
                           'leftCheek_425_x', 'leftCheek_425_y', ])

# Write the DataFrame to a CSV file
# csv_output_path = "Landmarks_Non_Stroke_Faces.csv"
csv_output_path = "Landmarks_Non_Stroke_Faces.csv"
